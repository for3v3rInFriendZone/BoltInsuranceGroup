(function() {
	...
	VehicleInsuranceController.$inject = ['localStorageService', '$state', 'InsuranceProgress', '$http', '$crypto'];
	function VehicleInsuranceController(localStorageService, $state, InsuranceProgress, $http, $crypto) {
